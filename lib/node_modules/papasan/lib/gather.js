...
/** @brief Prepare a response object for papasan use
 ...
 * response.error = [];
 * var pid = spawn( ... );
 * pid.stdout.on( 'data', this.papasan.gather.output.bind(response) );
 * pid.stderr.on( 'data', this.papasan.gather.error.bind(response) );
 */
